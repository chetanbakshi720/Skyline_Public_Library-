...
<?php
    ...
    if (isset($_POST['Save'])) {
        ...
        if(!isset($category)) 
        {
          $categoryError = "<li>You forgot to select your Gender!</li>";
        }
        
        if($quantity == ""){
           $quantityError = '<p style = "color:red; font-weight:normal">Please Enter Quantity.</p>'; 
        }
        ...
        if(!$bookNameError && !$isbnNoError && !$authorNameError && !$priceError && !$shortDescriptionError && !$categoryError && !$quantityError && !$editionError && !$publishYearError && !$rackInformationError && !$bookImageError && !$eBookError)
        {
               ...
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="error-msg"> <?php echo $quantityError; ?> </div>
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex ms-5">
                           ...
                           <div class="col-6 ">
                              <!-- <a class="text-success" href='user_login.php?role=user'> -->
                                 <input type="reset" class="btn btn-primary px-4 py-2 rounded-4  bg-success" name="back" value="Back" onclick = "window.location.href = 'staff_view_all_book.php'">
                              <!-- </a> -->
                           </div>
                        </div>
            </form>
